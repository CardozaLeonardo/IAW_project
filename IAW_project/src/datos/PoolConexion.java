...
public class PoolConexion 
{
	...
	private synchronized static void createInstance() // Este m�todo asigna a la instancia <<INSTANCE>> la instancia del objeto (Pool)
	{
		if(INSTANCE==null)
		{
	...
	public static PoolConexion getInstance() // Este m�todo retorna la instancia �nica del objeto (pool)
	{
		if(INSTANCE == null)
		{
			createInstance();
	 ...
	 public final void inicializaDataSource() // Este m�todo asigna los valores de fabrica para la creacion del origen de datos de conexion
	    {
